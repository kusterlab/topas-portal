    ...
    <v-card-text>
      ...
      <v-row class="mt-0">
        ...
        <v-col sm="4" lg="4" md="4">
          <v-btn :disabled="!showUpdateCohorts" hide-details @click="patientAnnotationUpdater">
      ...
      <v-row>
        ...
        <v-col sm="4" lg="4" md="4">
          <v-btn :disabled="!showUpdateCohorts" hide-details @click="sampleAnnotationUpdater">
      ...
      <v-row>
        ...
        <v-col sm="4" lg="4" md="4">
          <v-btn :disabled="!showUpdateCohorts" hide-details @click="reportDirUpdater">
  ...
  export default {
    ...
    methods: {
      ...
      async reloadCohort(allCohorts = false) {
        ...
        try {
          if (allCohorts) {
            response = await axios.get(`${import.meta.env.VITE_API_HOST}/drugs/load`)
