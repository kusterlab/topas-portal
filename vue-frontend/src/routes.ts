...
export const api = {
    ...
    CONFIG_UPDATE: ({key, cohort, value}) => `${API_HOST}/update/${key}/${cohort}/${value}`,
    ADD_COHORT: ({cohort}) => `${API_HOST}/addcohort/${cohort}`,
    ...
    ABUNDANCE: ({cohort_index, level, identifier, imputation}) => `${API_HOST}/${cohort_index}/${level}/abundance/${identifier}/${imputation}`,
