...
export const api = {
    ...
    VENN_PATIENT_COMPARE: ({cohort_index, level, patients}) => `${API_HOST}/venn/${cohort_index}/patientcompare/${level}/${patients}`,
    VENN_BATCH_COMPARE: ({cohort_index, level, batchlists}) => `${API_HOST}/venn/${cohort_index}/batchcompare/${level}/${batchlists}`,
    ...
    PATIENTS_METADATA: ({cohort_index, include_ref}) => `${API_HOST}/${cohort_index}/metadata/${include_ref}`,
    PATIENT_CENTRIC_SUMMED_INTENSITY: ({cohort_index, level, include_ref}) => `${API_HOST}/patientcentric/summed_intensity/${cohort_index}/${level}/${include_ref}`,
    PATIENT_CENTRIC_COUNTS: ({cohort_index, level, include_ref}) => `${API_HOST}/patientcentric/counts/${cohort_index}/${level}/${include_ref}`,
    ...
    PATIENT_REPORT_PPTX: ({cohort_index, patient, background_cohort}) => `${API_HOST}/${cohort_index}/patient_reports/${patient}/pptx?background_cohort=${background_cohort}`,
    TUMOR_ANTIGENS_SWARM_PLOT: ({cohort_index, patient, background_cohort, subcohort_column}) => `${API_HOST}/${cohort_index}/patients/${patient}/tumor-antigens/swarm?background_cohort=${background_cohort}&subcohort_column=${subcohort_column}`,
    RTKS_SWARM_PLOT: ({cohort_index, patient, background_cohort, subcohort_column}) => `${API_HOST}/${cohort_index}/patients/${patient}/rtks/swarm?background_cohort=${background_cohort}&subcohort_column=${subcohort_column}`,
    CKS_NKS_SWARM_PLOT: ({cohort_index, patient, background_cohort, subcohort_column}) => `${API_HOST}/${cohort_index}/patients/${patient}/cks-nks/swarm?background_cohort=${background_cohort}&subcohort_column=${subcohort_column}`,
    ...
    PRODICT_PATIENT_UMAP: ({cohort_index, patient, background_cohort}) => `${API_HOST}/${cohort_index}/patients/${patient}/prodict/umap?background_cohort=${background_cohort}`,
};