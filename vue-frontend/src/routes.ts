...
export const api = {
    ...
    VENN_PATIENT_COMPARE: ({cohort_index, level, patientslists}) => `${API_HOST}/venn/${cohort_index}/patientcompare/${level}/${patientslists}`,
    ...
    PATIENT_CENTRIC_SUMMED_INTENSITY: ({cohort_index, level}) => `${API_HOST}/patientcentric/summed_intensity/${cohort_index}/${level}`,
    PATIENT_CENTRIC_COUNTS: ({cohort_index, level}) => `${API_HOST}/patientcentric/counts/${cohort_index}/${level}`,
    ...
    TOPAS_LOLLIPOP: ({cohort_index, patient}) => `${API_HOST}/topas/lollipopdata/${cohort_index}/${patient}`,
    TOPAS_LOLLIPOP_TUMOR: ({cohort_index, patient}) => `${API_HOST}/topas/lollipopdata/${cohort_index}/${patient}/tumor_antigen`,
    TOPAS_EXPRESSION_DOWNSTREAM: ({cohort_index, patient}) => `${API_HOST}/topas/lollipopdata/expression/${cohort_index}/${patient}/downstream_signaling`,
    TOPAS_EXPRESSION_RTK: ({cohort_index, patient}) => `${API_HOST}/topas/lollipopdata/expression/${cohort_index}/${patient}/rtk`,
